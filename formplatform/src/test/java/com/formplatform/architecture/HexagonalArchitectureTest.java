package com.formplatform.architecture;
...
/**
 * Architecture tests for the FormPlatform microservice.
...
class HexagonalArchitectureTest {
    ...
    private static final String BASE_PACKAGE = "com.formplatform";
    ...
    class MicroserviceIsolation {
        ...
        @Test
        @DisplayName("FormPlatform classes should not depend on FormPresentationReceiver classes")
        void formplatformShouldNotDependOnFormpresentationreceiver() {
            ArchRule rule = noClasses()
                    .that().resideInAPackage("com.formplatform..")
                    .should().dependOnClassesThat()
                    .resideInAPackage("com.formpresentationreceiver..");
